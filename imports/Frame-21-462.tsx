import svgPaths from "./svg-eo7v23buvp";
...
function Frame1() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row items-center justify-center left-[514px] overflow-clip p-0 size-[60px] top-0"
      data-name="Frame"
    >
      <Frame />
    </div>
...
function Div4() {
  return (
    <div
      className="absolute bg-[rgba(0,0,0,0)] h-[60.5px] left-0 top-0 w-[1088px]"
      data-name="div"
    >
      <div
        aria-hidden="true"
...
function Div5() {
  return (
    <div
      className="absolute bg-[rgba(0,0,0,0)] h-[196.5px] left-8 top-16 w-[1088px]"
      data-name="div"
    >
      <div
        aria-hidden="true"
      ...
      />
      <Div4 />
      <div className="absolute font-['Inter:Bold',_sans-serif] font-bold h-11 leading-[0] left-[546.5px] not-italic text-[#000033] text-[36px] text-center top-[84.5px] translate-x-[-50%] w-[348px]">
        <p className="block leading-[40px]">Connexion membre</p>
      </div>
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-14 leading-[0] left-[546.84px] not-italic text-[#43464b] text-[18px] text-center top-[140.5px] translate-x-[-50%] w-[613px]">
        <p className="block leading-[28px]">
          Accédez à votre tableau de bord membre, aux ressources exclusives et
          connectez-vous avec la communauté ASL.
        </p>
      </div>
    </div>
  );
...
function Main() {
  return (
    <div
      className="absolute bg-[rgba(0,0,0,0)] h-[1380.5px] left-36 top-20 w-[1152px]"
      data-name="main"
    >
      <div
        aria-hidden="true"
